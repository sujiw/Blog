...
class Page{
    ...
    public function show() {
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages){
            ...
            $the_end = '<a href="' . $this->url($this->totalPages) . '" class="layui-laypage-last">' . $this->config['last'] . '</a>';
        }
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    ...
                    $link_page .= '<span class="layui-laypage-curr"><em class="layui-laypage-em" style="background-color:#1E9FFF;"></em><em>' . $page . '</em></span>';
                }
            }
        }
