...
//定义回调URL通用的URL
define('URL_CALLBACK', 'https://' . $_SERVER['SERVER_NAME'] . '/Home/User/callback/type/');
...
return array(
    ...
    //腾讯QQ登录配置
    'THINK_SDK_QQ' => array(
        'APP_KEY' => '101473050', //应用注册成功后分配的 APP ID
        'APP_SECRET' => '56cbbd3e1cd27f986618fb10fe22fc93', //应用注册成功后分配的KEY
